...
class MovieManageControl extends Control
{
    /**
     * 帖子管理
     */
    ...
    private function _get()
    {
        $form_cond_conf = array(
            'title'         =>  array("transform", array($this, 'likeFormat'), ErrorCode::PARAM_ERROR, 'null_skip'),
            'username'      =>  array("transform", array($this, 'likeFormat'), ErrorCode::PARAM_ERROR, 'null_skip'),
            'posttime'      =>  array("transform", array($this, 'betweenTimeFormat'), ErrorCode::PARAM_ERROR, 'null_skip'),
        );
        $where_arg = RemoteInfo::getSearchFormArgs($form_cond_conf);
    
        $select_ary = array('postid', 'title', 'userid', 'username', 'posttime', 'reply', 'lastreply');
